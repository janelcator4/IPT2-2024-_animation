        ...
        <div className="home-container">
            ...
            <header className="hero text-center py-5">
                <div className="hero-content">
                    ...
                    <p className="lead text-white">
                        Join our community of learners and unlock endless
                        opportunities.
                    </p>
                            ...
                            <div className="card feature-box text-center shadow-sm">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        ...
                                        industry standards and prepare students
                            ...
                            <div className="card feature-box text-center shadow-sm">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        ...
                                        learning options to fit your schedule.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-4 mb-4">
                            <div className="card feature-box text-center shadow-sm">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        Engage with our interactive tools and
                        ...
                        <div className="col-md-4 mb-4">
                            <div className="card feature-box text-center shadow-sm">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        Join a community of learners and get
                        ...
                        <div className="col-md-4 mb-4">
                            <div className="card feature-box text-center shadow-sm">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        Benefit from our career services to help
            ...
            <section className="cta bg-primary text-white text-center py-5">
                <div className="container">
                    ...
                    <p>
                        Start your application now and take the first step
